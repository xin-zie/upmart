    ...
    <div class="main-container">
        <div class="form-container">
            <?php if (isset($_GET['reset']) && $_GET['reset'] == 'complete'): ?>
                <div style="background-color: #e8f5e9; color: #2e7d32; padding: 15px; border-radius: 8px; border: 1px solid #a5d6a7; text-align: center; position: absolute; top: 20px; left: 50%; transform: translateX(-50%); width: 80%; z-index: 10;">
