...
<body>
   ...
   <div id="reportModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <form id="reportForm">
                <label for="reported_name">Who do you want to report?</label>
                <input type="text" id="reported_name_input" name="reported_name" list="user_suggestions" placeholder="Type a name..." autocomplete="off">
                ...
                <select id="postReportType" name="reason" required>
                ...
                <textarea id="reportDetails" name="details" placeholder="Please describe the issue..." required></textarea>
